<?php
require_once("./Includes/BOL/product.php");
    ...
    public function GetProductsBySomething(string $what): array
    {
        ...
        foreach ($this->Products  as $product) {
            if (
                ...
                ($this->ProductHasTag($product, $what) && !$this->ContainsProduct($result, $product))
            ) {

    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div id="navbarContenu" class="collapse navbar-collapse">
            ...
            <form class="form-inline my-2 my-lg-0" action="{{ url('search') }}" method="post">
                @csrf
                <input id="what" name="what" class="form-control mr-sm-2" type="search" placeholder="Rechercher produits" aria-label="Rechercher produits" required value="{{ old('what') }}">
                <input class="btn btn-outline-success my-2 my-sm-0" type="submit" aria-label="Rechercher" value="Rechercher">
